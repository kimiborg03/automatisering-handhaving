                                    ...
                                    @endforeach
                                                                    ...
                                                                    @push('scripts')
                                                                        ...
                                                                        <script>
                                                                                ...
                                                                                func        tion prepareConfirm(toMatch) {
                                                                                    ...
                                                                                    cons                                                                                            ole.log("Verwijderen uit match", fromMatchId, userId);
                                                                                        ...
                                                                                        body        : JSON.stringify({ user_id: userId })
                                                                                                ...
                                                                                                .then(()         => {
                                                                                            cons        ole.log("Toevoegen aan match", toMatchId);
                                                                                            return f        etch(`/match/${toMatchId}/update`, {
                                                                                                meth        od: 'POST',
                                                                                                        headers: {
                                                                                                            'Content-Type': 'application/json',
